...
var HTMLwelcomeMsg = '<span class="welcome-message header-flex-box">%data%</span>';

var HTMLskillsStart = '<div class="header-flex-box"><h3 id="skillsH3">Skills at a Glance:</h3></div><ul id="skills" class="header-flex-box"></ul>';
